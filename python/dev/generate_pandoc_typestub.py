...
"""
Use the string representations of base Pandoc types to generate typestubs for those types,
including correct __init__, __getattr__, __setattr__ functions.
The latter are overloaded with the right types for the right literals
e.g. Cite([Citation], [Inline]) translates to a Python class where `cite[0]: List[Citation]`
and `cite[1]: List[Inline]`.
"""
...
def main(out_path: str) -> None:
    ...
    with open(out_path, "w", encoding="utf-8") as f:
        ...
        )  # TODO this is prob unnecessary. mypy complains about "from typing import *override*" but not *overload*.
